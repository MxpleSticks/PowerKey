    ...
    def __init__(self):
        ...
        self.themes = {
            'dark': {
                ...
                'success': '#4CAF50',
                'error': '#f44336',
                'button_text': '#ffffff'  # Added explicit button text color
            },
            'light': {
                'bg': '#f0f0f0',
                'fg': '#000000',
                ...
                'success': '#4CAF50',
                'error': '#f44336',
                'button_text': '#ffffff'  # Keep button text white in light mode
            }
        }
...
/8AA////////wAA="""
    ...
    def setup_styles(self):
        ...
        # Update button styles to keep white text
        self.style.configure('TButton',
                           background=self.colors['button'],
                           foreground=self.colors['button_text'],  # Use consistent white text
                           font=('Segoe UI', 10),
                           padding=8)
        ...
        self.style.map('TButton',
                      foreground=[('active', self.colors['button_text'])],  # Keep text white on hover
...
"""
    ...
    def check_hotkey(self, e):
        if self.settings['hotkeys_enabled'] and keyboard.is_pressed('ctrl+shift+alt'):
            key = e.name.upper()
